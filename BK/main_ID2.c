...
// #define MAIN_BOARD_ID1
#define MAIN_BOARD_ID2
...
static void MX_USART2_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART2_Init 2 */
	 if(HAL_UART_Receive_IT(&huart2, aRxBuffer_uart2,1) != HAL_OK)
	 	{
...
static void MX_USART3_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART3_Init 2 */
	 if(HAL_UART_Receive_IT(&huart3, aRxBuffer_uart3,1) != HAL_OK)
	 	{
...
void handle_data_uart_mfm3883_ID1(void)
{
    ...
    if(slaveID1 == 0 || slaveID1 > METER_MAX)
        return;

    MFM383A_Data_t *meter = &g_meter[slaveID1];

    meter->V1N        = modbusPyloadToFloat(&rx_nfn383_ID1[3]);
    meter->V2N        = modbusPyloadToFloat(&rx_nfn383_ID1[7]);
    meter->V3N        = modbusPyloadToFloat(&rx_nfn383_ID1[11]);
    meter->AvgVLN     = modbusPyloadToFloat(&rx_nfn383_ID1[15]);

    meter->V12        = modbusPyloadToFloat(&rx_nfn383_ID1[19]);
    meter->V23        = modbusPyloadToFloat(&rx_nfn383_ID1[23]);
    meter->V31        = modbusPyloadToFloat(&rx_nfn383_ID1[27]);
    meter->AvgVLL     = modbusPyloadToFloat(&rx_nfn383_ID1[31]);

    meter->I1         = modbusPyloadToFloat(&rx_nfn383_ID1[35]);
    meter->I2         = modbusPyloadToFloat(&rx_nfn383_ID1[39]);
    meter->I3         = modbusPyloadToFloat(&rx_nfn383_ID1[43]);
    meter->AvgCurrent = modbusPyloadToFloat(&rx_nfn383_ID1[47]);

    meter->kW1        = modbusPyloadToFloat(&rx_nfn383_ID1[51]);
    meter->kW2        = modbusPyloadToFloat(&rx_nfn383_ID1[55]);
    meter->kW3        = modbusPyloadToFloat(&rx_nfn383_ID1[59]);

    meter->kVA1       = modbusPyloadToFloat(&rx_nfn383_ID1[63]);
    meter->kVA2       = modbusPyloadToFloat(&rx_nfn383_ID1[67]);
    meter->kVA3       = modbusPyloadToFloat(&rx_nfn383_ID1[71]);

    meter->kVAR1      = modbusPyloadToFloat(&rx_nfn383_ID1[75]);
    meter->kVAR2      = modbusPyloadToFloat(&rx_nfn383_ID1[79]);
    meter->kVAR3      = modbusPyloadToFloat(&rx_nfn383_ID1[83]);

    meter->TotalkW    = modbusPyloadToFloat(&rx_nfn383_ID1[87]);
    meter->TotalkVA   = modbusPyloadToFloat(&rx_nfn383_ID1[91]);
    meter->TotalkVAR  = modbusPyloadToFloat(&rx_nfn383_ID1[95]);

    meter->PF1        = modbusPyloadToFloat(&rx_nfn383_ID1[99]);
    meter->PF2        = modbusPyloadToFloat(&rx_nfn383_ID1[103]);
    meter->PF3        = modbusPyloadToFloat(&rx_nfn383_ID1[107]);
    meter->AvgPF      = modbusPyloadToFloat(&rx_nfn383_ID1[111]);

    meter->Frequency  = modbusPyloadToFloat(&rx_nfn383_ID1[115]);
    meter->kWh        = modbusPyloadToFloat(&rx_nfn383_ID1[119]);
